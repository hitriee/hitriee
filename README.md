# 🚀 안녕하세요, 다정함을 발휘하며 개발하는 개발자 나원경입니다.
<br>
...
## 💼 경력 사항
> **리안소프트**(스타트업 회사)에서 5개월간 인턴 생활을 하며 요구사항 파악과 AI 활용 역량을 길렀습니다.
<br>

### 1. Mental Assistant (멘털 어시스턴트) - AI를 활용한 감정 분석 서비스
- 역할 : 프론트엔드 / 디자인 제외한 화면과 기능 구현
- 사용 기술 : React, Typescript, Chakra UI 등
- 주요 성과
  - 하단 바, 하단 시트, 달력 등을 활용한 모바일 최적화 화면 구현
  - 기종별 UI 차이를 줄이기 위한 3개 이상의 기기 테스트
  - 기능 고도화의 일종으로 다국어 설정 기능 구현

<br>

### 2. PT하자 - AI를 활용한 발표 보조 플랫폼
- 역할 : 프론트엔드 / 퍼블리싱 이후 작업 수행, MVP 제작
- 사용 기술 : Next.js, Typescript 등
- 주요 성과
  - 사용자 편의성과 개발자 편의성을 고려한 데이터 형식 설계
  - CSS flex를 활용해 발표 대본과 실제 음성 비교 UI 구현
  - 스스로 목표를 설정하고 세부화하며 시간 관리 역량 향상
  - 웹소켓 통신 적용으로 기존 대비 발표 대본 조회 api 통신 시간을 약 20% 감축

<br>
<br>

## 📂 개발 프로젝트
*프로젝트명을 클릭하면 해당 레포지토리로 이동합니다.*
*프로젝트는 최신 순으로 정렬했습니다.*

| 프로젝트 명 | 개요 | 사용 기술 |
| :--- | :--- | :--- |
| **[Bin:goT](https://github.com/chaewool/Bin-goT)** | 빙고판에 입력한 목표를 달성해가는 서비스 (안드로이드 앱) | Flutter, Dart, Provider |
| **[화장실을 찾아서](https://github.com/4ilet/Find_Toilet)** | 주변의 화장실을 표시해주는 서비스 (안드로이드 앱) | Flutter, Dart, Provider |
| **[동하책](https://github.com/hitriee/fairytail)** | 하고 싶은 말을 풍선에 담아 날리는 위치 기반 익명 커뮤니티 (PWA) | React, Typescript, three.js, fcm, firestore |
| **[Enimal (에니멀)](https://github.com/hitriee/Enimal)** | NFT를 이용한 멸종 위기 동물 보호 관심 재고 및 기부 독려 사이트 (웹) | Javascript, Solidity, web3.js, express |
